...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	SpriteFrameCache::getInstance()->addSpriteFramesWithFile("level-sheet1.plist");
	...
	Animation* diamondAinmation = Animation::create();
	for (int i = 0; i < 7; ++i) {
		sprintf(frameName, "diamond-%d.png", i);
		diamondAinmation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName));
	}
	diamondAinmation->setDelayPerUnit(0.1);
	AnimationCache::getInstance()->addAnimation(diamondAinmation, "diamondAinmation");
